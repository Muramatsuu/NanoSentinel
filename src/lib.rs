...
#[derive(Debug)]
pub struct NanoSentinelProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoSentinelProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoSentinel processing");
    
    let mut processor = NanoSentinelProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoSentinelProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoSentinelProcessor::new(false);
